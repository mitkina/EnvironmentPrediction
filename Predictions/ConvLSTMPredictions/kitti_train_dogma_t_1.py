...
weights_file = os.path.join(WEIGHTS_DIR, 'prednet_full_kitti_weights_dogma_t_1.hdf5')  # where weights will be saved
json_file = os.path.join(WEIGHTS_DIR, 'prednet_full_kitti_model_dogma_t_1.json')
...
# Model parameters
n_channels, im_height, im_width = (3, 128, 128)
