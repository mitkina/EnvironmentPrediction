...
X_test = np.expand_dims(0.5*(X_test[:,:,:,:,0]) + 0.5*(1.-X_test[:,:,:,:,1]), axis=-1)
X_hat = np.expand_dims(0.5*(X_hat[:,:,:,:,0]) + 0.5*(1.-X_hat[:,:,:,:,1]), axis=-1)

RESULTS_SAVE_DIR_OCC = RESULTS_SAVE_DIR + "EvidentialGridsDST/"
