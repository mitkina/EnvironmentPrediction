...
class Particle(object):
    ...
    # INPUT: 
    # state size: 4 (pos, vel) or 6 (pos, vel, acc)
    ...
    def __init__(self, position, index, weight, state_size=4, p_S=0.99, scale_vel = 5., scale_acc = 2., \
        ...
        self.p_S = p_S
        # Initialization: UNIFORM FOR NOW, WITH STATIC ASSUMPTION AT START
        self.weight = weight
        self.index = index
    ...
    def predict(self, transition_matrix, noiseSD = 0.1):
        # process noise should be constant for each time step
